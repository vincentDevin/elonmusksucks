...
export function generatePasswordResetEmail(options: PasswordResetEmailOptions): string {
  ...
  const content = `
    ...
    <p style="margin: 20px 0 0 0; color: #9CA3AF; font-size: 14px;">
      ...
      <a href="${resetUrl}" style="color: #34D399; text-decoration: none; word-break: break-all;">${resetUrl}</a>
    </p>

    <hr style="border: none; border-top: 1px solid #374151; margin: 32px 0;" />

    <p style="margin: 0 0 12px 0; color: #9CA3AF; font-size: 14px; font-weight: 600;">
      Security Tips:
    </p>
    <ul style="margin: 0; padding-left: 20px; color: #D1D5DB; font-size: 13px; line-height: 1.6;">
