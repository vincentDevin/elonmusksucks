...
const testArticles = [
  {
    ...
    excerpt:
      'Tesla has rolled out a new software update that brings significant improvements to Autopilot functionality for Model 3 owners.',
  ...
  },
  {
    ...
    excerpt:
      'SpaceX is gearing up for another Starship test flight as the company continues to refine its Mars colonization vehicle.',
  ...
  },
  {
    ...
    excerpt:
      'The social media platform formerly known as Twitter rolls out updated moderation tools in response to user feedback.',
  ...
  },
  {
    ...
    excerpt:
      'The first human patient in Neuralinks brain implant trial demonstrates significant improvements in controlling devices with thought.',
  ...
  },
  {
    ...
    excerpt:
      'The meme cryptocurrency saw a 15% increase following a cryptic social media post from the Tesla CEO.',
