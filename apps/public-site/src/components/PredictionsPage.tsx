    ...
    <div className="bg-background text-content min-h-screen">
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-12">
            ...
            <div className="grid gap-4">
              {resolvedPredictions.slice(0, 5).map((prediction) => {
                ...
                return (
                  <div key={prediction.id} className="bg-surface rounded-lg p-4 shadow opacity-75">
        ...
        <div className="bg-surface rounded-lg p-8 text-center shadow">
          ...
          <p className="text-tertiary mb-6">Join thousands of users predicting Elon's next move</p>
          <a
            href={`${clientAppUrl}/register`}
