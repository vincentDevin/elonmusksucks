    ...
    <div className="bg-background text-content min-h-screen">
      ...
      <div className="container mx-auto px-2 py-3">
        <div className="max-w-[1800px] mx-auto space-y-3">
          {/* Top Row: Predictions, Articles, Community */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <div className="section-card p-4">
              ...
              {openPredictions.length > 4 && (
                ...
                >
                  {showAllPredictions ? '▲ Show Less' : `▼ Show ${openPredictions.length - 4} More`}
                </button>
              )}
            </div>
            ...
            <div className="section-card p-4">
              <h2 className="text-base font-bold mb-3 flex items-center justify-between">
                ...
                <span className="text-xs text-tertiary font-normal">{articles.length} total</span>
              </h2>
              <div className="space-y-3">
                {articles.slice(0, showAllArticles ? articles.length : 4).map((article: any) => (
                  <div key={article.id} className="preview-card p-4">
                    ...
                    {article.content.excerpt && (
                      <p className="text-sm text-content/80 mb-3 line-clamp-3 leading-relaxed">
                        {article.content.excerpt}
                      </p>
                    )}
            ...
            <div className="section-card p-4">
              <h2 className="text-base font-bold mb-3 flex items-center justify-between">
                ...
                <span className="text-xs text-tertiary font-normal">{posts.length} posts</span>
              </h2>
              <div className="space-y-3">
