...
export const ArticleDrawer: React.FC<ArticleDrawerProps> = ({
  ...
  return (
    <>
      {/* Backdrop */}
      <div
        className="fixed inset-0 bg-surface/30 backdrop-blur-sm z-40 transition-opacity"
        onClick={onClose}
      />

      {/* Drawer */}
      <div className="fixed inset-y-0 right-0 w-full max-w-2xl bg-surface shadow-xl z-50 transform transition-transform duration-300 overflow-y-auto">
        {/* Header */}
        <div className="sticky top-0 bg-surface border-b border-muted px-6 py-4">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-semibold text-content">Article Details</h2>
            <button
              onClick={onClose}
              className="text-content/60 hover:text-content/80 transition-colors"
            >
        ...
        <div className="px-6 py-6">
          ...
          {item && !loading && (
            <>
              ...
              {/* Actions */}
              <div className="sticky bottom-0 bg-surface border-t border-muted pt-6 -mx-6 px-6 pb-6">
                <div className="flex space-x-3">
                  <button
