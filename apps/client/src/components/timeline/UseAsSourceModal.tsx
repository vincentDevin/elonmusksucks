      ...
      <div className="bg-surface border border-muted rounded-2xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-hidden">
        ...
        <div className="p-6 border-b border-muted">
          <div className="flex items-start justify-between">
            ...
            <button
              onClick={onClose}
              className="text-content/60 hover:text-content transition-colors text-2xl ml-4"
            >
              ×
            </button>
          </div>
          ...
          {!user && (
            <div className="text-center py-8">
              <p className="text-content/70 mb-4">
                You need to be logged in to create predictions.
              </p>
              <button
        ...
        {/* Footer */}
        <div className="p-6 border-t border-muted bg-muted/5">
          <div className="flex justify-between items-center">
            ...
            <button
              onClick={onClose}
              className="px-4 py-2 text-content/70 hover:text-content transition-colors text-sm"
            >
              Cancel
            </button>
          </div>
