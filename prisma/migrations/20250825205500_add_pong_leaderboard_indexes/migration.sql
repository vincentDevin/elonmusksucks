...
CREATE INDEX IF NOT EXISTS "PongStats_totalWagered_idx" ON "PongStats"("totalWagered" DESC);

-- Add index for perfect games leaderboard (perfectGames DESC)
CREATE INDEX IF NOT EXISTS "PongStats_perfectGames_idx" ON "PongStats"("perfectGames" DESC);